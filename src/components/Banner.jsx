...
const Banner = () => {
    return (
        <div className="relative">
            <div className="bg-[#9538E2] pt-5 min-h-[calc(100vh-200px)] rounded-b-2xl">
            ...
            <div className="absolute top-80 left-0 md:top-60  lg:top-70 lg:left-[40px] xl:left-[170px] 2xl:left-[287px]">
